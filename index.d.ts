...
export type Options = BaseOptions & {
	...
	*/
	...
	/**
	When `false`, instead of rejecting with an `AggregateError` when `stopOnError` is `false`, it will resolve with an array of objects similar to `Promise.allSettled`.
