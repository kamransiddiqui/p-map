...
It is calculated from `os.cpus().length` and is capped at 8 to avoid overwhelming the system. In CI environments, it is set to 2 to avoid overwhelming the CI runner.
